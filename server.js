...
const commentRouter = require('./Routes/comment_api');
const replyRouter=require('./Routes/reply_api');
...
app.use('/forum/comment_page', commentRouter);
app.use('/forum/comment_page', replyRouter);
//HTTP request logger
app.use(morgan('tiny'));
app.use('/api', routes);
